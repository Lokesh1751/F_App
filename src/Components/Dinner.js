...
import { dinnerItems } from "../data/data";
  ...
  return (
    ...
    >
      ...
      <div className="flex  space-x-3 xl:space-x-48 my-5">
        ...
        <div className="text-orange-700 underline text-lg font-bold cursor-pointer hover:text-orange-700 duration-300 xl:text-2xl">
          <Link to="/dinner" className="flex"> <FaUtensils size={30} className="text-orange-700 pr-1" /> Dinner</Link>
        </div>
      </div>
