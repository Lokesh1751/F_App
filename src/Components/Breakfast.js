...
import { breakfastItems } from "../data/data";
const BreakFast = () => {
  return (
    <div
    ...
    >
      ...
      <div className="flex  space-x-3 xl:space-x-48 my-5">
        <div className="text-orange-700 text-lg font-bold cursor-pointer hover:text-orange-700 duration-300 xl:text-2xl ml-12 xl:ml-[290px] underline">
        <Link to="/break" className="flex "> < FaBreadSlice size={30} className="text-orange-700 pr-1 no-underline" /> BreakFast</Link>
        </div>
